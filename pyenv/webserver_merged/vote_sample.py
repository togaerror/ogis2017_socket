...
def Vote():
    ...
    # 2値化
    ret, img_gray_thresh = cv2.threshold(img_gray, threshold_value, 255, cv2.THRESH_BINARY_INV)
    # 結果を出力
    ...
    # 2値化
    ret, img_gray_thresh2 = cv2.threshold(img_gray2, threshold_value, 255, cv2.THRESH_BINARY_INV)
    # 結果を出力
    ...
    # 差分検出
    img_dst = cv2.absdiff(img_gray_thresh, img_gray_thresh2)
